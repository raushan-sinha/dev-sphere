...
const MobileNavbar = () => {
    ...
    const [isProfileBoardOpen, setIsProfileBoardOpen] = useState<boolean>(false);
    ...
    return (
        <>
            <nav
                ...
                <Link
                    to="/"
                    className="text-gray-300 text-lg font-sans font-bold tracking-wide focus:outline-none gradient-text">
                    {title}
                </Link>
