  ...
  return (
    <>
      ...
      <div
        ...
        {/* Menu Panel */}
        <div
          className={`absolute top-20 left-1/2 -translate-x-1/2 w-[92%] rounded-2xl bg-[#101923]/95 backdrop-blur-xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.6)] p-6 transition-all duration-300 ${
